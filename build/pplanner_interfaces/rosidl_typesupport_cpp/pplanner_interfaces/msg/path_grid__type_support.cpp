...
static const _PathGrid_type_support_symbol_names_t _PathGrid_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pplanner_interfaces, msg, PathGrid)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pplanner_interfaces, msg, PathGrid)),
  }
};
...
{
  return &::pplanner_interfaces::msg::rosidl_typesupport_cpp::PathGrid_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, pplanner_interfaces, msg, PathGrid)() {
  return get_message_type_support_handle<pplanner_interfaces::msg::PathGrid>();
}
