...
#include "pplanner_interfaces/msg/detail/aruco_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const pplanner_interfaces::msg::ArucoData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pplanner_interfaces::msg::ArucoData & ros_message)
{
  // Member: id_data
  cdr >> ros_message.id_data;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pplanner_interfaces::msg::ArucoData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const pplanner_interfaces::msg::ArucoData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pplanner_interfaces::msg::ArucoData *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ArucoData__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const pplanner_interfaces::msg::ArucoData *>(
...
static size_t _ArucoData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ArucoData(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ArucoData__callbacks = {
...
static rosidl_message_type_support_t _ArucoData__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ArucoData__callbacks,
...
{
  return &pplanner_interfaces::msg::typesupport_fastrtps_cpp::_ArucoData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pplanner_interfaces, msg, ArucoData)() {
  return &pplanner_interfaces::msg::typesupport_fastrtps_cpp::_ArucoData__handle;
}
