...
static const _PathGridset_type_support_symbol_names_t _PathGridset_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pplanner_interfaces, msg, PathGridset)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pplanner_interfaces, msg, PathGridset)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, pplanner_interfaces, msg, PathGridset)() {
  return &::pplanner_interfaces::msg::rosidl_typesupport_c::PathGridset_message_type_support_handle;
}
